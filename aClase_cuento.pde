class Cuento {
  ...
  int [][] historia = {  {1,1}, // P0 presentacion = (P1 estampida / P1 estampida)  (página en la que continúa)
                ...
                /*13*/   {0,14}, //  P13 ScarMuere = (P0 presentacion / P14 creditos)
    ...
    if (!jugar) {
      ...
      switch (Laberito_mufasa.jugar()) {
        case 1: // juego terminó y ganó  
           nroPagina = 6; //pasamos a la pagina 6
           jugar=false;
        break;
        case 2: // juego terminó y perdió
           nroPagina = 13; //pasamos a la pagina 13
           jugar=false;
        break;        
...
//----------------------------------------------------------------------
  void teclado (){
    ...
    if (jugar) {
      ...
      nroPagina = historia[nroPagina][1]; // cambio la pagina
