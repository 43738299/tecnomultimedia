...
void setup(){
  ...
  //pantalla [1] = loadImage("presentacion.jpg"); //P1
  //pantalla [2] = loadImage ("Estampida.jpg"); //P2
  //pantalla [3] = loadImage ("Estampida.jpg"); //P3
  //pantalla [4] = loadImage ("reinoLuto.jpg"); //P4
  //pantalla [5] = loadImage ("reinoScar.jpg"); //P5
  //pantalla [6] = loadImage ("scarHuye.jpg"); //P6
  //pantalla [7] = loadImage ("pelea.jpg"); //P7
  //pantalla [8] = loadImage ("TodoAntes.jpg"); //P8
  //pantalla [9] = loadImage ("scarReino.jpg"); //P9
  //pantalla [10] = loadImage ("sym.jpg"); //P10
  //pantalla [11] = loadImage ("elefantes.jpg"); //P11
  //pantalla [12] = loadImage ("encuentra.jpg"); //P12
  //pantalla [13] = loadImage ("scarVive.jpg"); //P13
  //pantalla [14] = loadImage ("scarMuere.png"); //P14
  
  
  opciones [1][1] = 2; //OPCION 1 DE LA PANT. 1
  opciones [1][2] = 2; //OPCION 2 DE PANT. 1
  opciones [2][1] = 3; //OPCION 1 DE LA PANT. 2
  opciones [2][2] = 6; 
  opciones [3][1] = 4; 
  opciones [3][2] = 5;
  opciones [4][1] = 1; 
